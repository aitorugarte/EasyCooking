...
\t\t";
        // line 18
        $this->loadTemplate("Cooker:CookingBundle:Comment:list.html.twig", "CookerCookingBundle:Cook:show.html.twig", 18)->display(array_merge($context, array("comments" => ($context["comments"] ?? null))));
        // line 19
        echo "\t</section>
