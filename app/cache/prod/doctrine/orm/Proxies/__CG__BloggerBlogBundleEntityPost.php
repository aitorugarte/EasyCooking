 ...
 */
class Post extends \Blogger\BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Post' . "\0" . 'comments', 'id', 'title', 'body', 'date');
        }
    ...
    public function getBody($length = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBody', array($length));

        return parent::getBody($length);
    }
