 ...
 */
class Receta extends \Blogger\BlogBundle\Entity\Receta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blogger\\BlogBundle\\Entity\\Receta' . "\0" . 'comments', 'id', 'title', 'detalles', 'date');
        }
