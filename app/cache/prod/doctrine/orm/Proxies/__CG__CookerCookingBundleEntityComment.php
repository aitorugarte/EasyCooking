 ...
 */
class Comment extends \Cooker\CookingBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'user', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'approved', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'receta', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'created', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comment' . "\0" . 'updated');
        }
