 ...
 */
class Comentario extends \Cooker\CookingBundle\Entity\Comentario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'id', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'usuario', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'comentario', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'approved', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'receta', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'created', '' . "\0" . 'Cooker\\CookingBundle\\Entity\\Comentario' . "\0" . 'updated');
        }
